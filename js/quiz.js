...
// Helping Varibles
let quizsData = {
    quiz_1: {url: "./json/ar-quiz-1.json", length: 9},
    quiz_2: {url: "./json/ar-quiz-2.json", length: 6},
};
let length = quizsData[location.hash.slice(1)].length;
let dataUrl = quizsData[location.hash.slice(1)].url;
let questionIdx = 0;
